...
def get_args():
	...
	parser.add_argument('--decensor_output_original_path', dest='decensor_output_original_path', default='./decensor_original_output/', help='move input images there after processing')
	...
	parser.add_argument('--loop', dest='loop', default="False", type=str2bool, help='Enable to run continuously')
